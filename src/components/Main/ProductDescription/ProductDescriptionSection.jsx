...
const ProductDescriptionSection = () => {
    return (
        <div className={"flex flex-col gap-8"}>
            ...
            <h1 className={"text-preset-1 leading-preset-1 font-preset-1"}>Fall Limited Edition Sneakers</h1>
            <p className={"text-preset-3 leading-preset-3 text-grey-500"}>These low-profile sneakers are your perfect casual wear companion. Featuring a durable rubber outer sole, they’ll withstand everything the weather can offer.</p>
            <ProductPriceSection/>
